<?php echo Form::open(array("class"=>"form-horizontal")); ?>
	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('Scientific name', 'scientific_name', array('class'=>'control-label')); ?>

				<?php echo Form::textarea('scientific_name', Input::post('scientific_name', isset($plant) ? $plant->scientific_name : ''), array('class' => 'col-md-8 form-control', 'rows' => 8, 'placeholder'=>'Scientific name')); ?>
